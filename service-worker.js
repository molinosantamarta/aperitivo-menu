...
const APP_SHELL = [
  ...
  "./src/styles.css?v=20260419m",
  "./generated/main.runtime.20260419m.js",
  ...
  "./menu-assets/sgb-molino-black.png?v=20260419m",
  "./menu-assets/instagram-logo.webp?v=20260419m",
  "./farfalla-bianca.webp?v=20260419m",
  "./format-carousel/bbq-picnic.png?v=20260419m",
  "./format-carousel/bbq-stelle.png?v=20260419m",
  "./format-carousel/cinema.png?v=20260419m",
  "./format-carousel/country.png?v=20260419m",
  "./format-carousel/dam.png?v=20260419m",
  "./format-carousel/ig-agrieventi.png?v=20260419m",
  "./format-carousel/agrieventi-logo.png?v=20260419m",
  "./format-carousel/bbq-hub.png?v=20260419m",
